...
import 'package:lawyer_app/clients/clientPanel.dart';
...
class ClientLogin extends StatelessWidget {
  ...
  Future<FirebaseUser> _signIn(BuildContext context) async {
    ...
    List<ProviderLawyerDetails> providerData = <ProviderLawyerDetails>[];
...
class ClientDetails {
  ...
  ClientDetails(this.providerDetails, this.userName, this.photoUrl,
      this.userEmail, this.providerData);
}

class ProviderClientDetails {
  ProviderClientDetails(this.providerDetails);
