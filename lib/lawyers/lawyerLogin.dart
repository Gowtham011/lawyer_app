...
import 'package:lawyer_app/lawyers/lawyerPanel.dart';
...
class _LawyerLoginState extends State<LawyerLogin> {
  ...
  Future<FirebaseUser> _signIn(BuildContext context) async {
    ...
    ProviderLawyerDetails providerInfo =
        new ProviderLawyerDetails(userDetails.uid);

    List<ProviderLawyerDetails> providerData =
        // ignore: deprecated_member_use
        <ProviderLawyerDetails>[];
    providerData.add(providerInfo);

    LawyerDetails details = new LawyerDetails(
      userDetails.uid,
...
class LawyerDetails {
  late final String providerDetails;
  late final String userName;
  late final String photoUrl;
  late final String userEmail;
  late final List<ProviderLawyerDetails> providerData;

  LawyerDetails(this.providerDetails, this.userName, this.photoUrl,
      this.userEmail, this.providerData);
}

class ProviderLawyerDetails {
  ProviderLawyerDetails(this.providerDetails);
