...
class LawyerProfile extends StatefulWidget {
  final LawyerDetails lawyerDetails;

  LawyerProfile({required this.lawyerDetails});
...
class _LawyerProfileState extends State<LawyerProfile> {
  ...
  profileUpdate() {
    Firestore.instance
        .collection('lawAbout')
        .document(widget.lawyerDetails.userEmail)
        .setData({
                  ...
                  children: <Widget>[
                    Hero(
                      ...
                      child: CircleAvatar(
                        radius: height * 0.05,
                        backgroundImage:
                            NetworkImage(widget.lawyerDetails.photoUrl),
                      ),
                    ),
                    SizedBox(
                      height: height * 0.03,
                    ...
                    Text(
                      widget.lawyerDetails.userName,
                      style:
                          TextStyle(fontWeight: FontWeight.bold, fontSize: 24),
                    ),
                    SizedBox(height: height * 0.007),
                    Text(
                      "Email: " + widget.lawyerDetails.userEmail,
                      style: TextStyle(
                          ...
                          !aboutCheck
                              ? StreamBuilder(
                                  stream: Firestore.instance
                                      .document(
                                          'lawAbout/${widget.lawyerDetails.userEmail}')
                                      .snapshots(),
